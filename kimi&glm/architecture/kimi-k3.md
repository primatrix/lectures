# Kimi K3 架构：从 Token、Depth、Channel 三个维度扩展信息流

> 状态：基于 2026-07-29 可获得的官方技术报告、模型卡、公开配置与 Hugging Face 推理实现整理。
>
> 用途：这是架构部分的主讲义和后续网页内容底稿，不是 benchmark 宣传稿，也不把尚未在 TPU 上验证的性能推断写成结论。
...
更完整的资料优先级、图表页码和使用注意事项见 [`../sources/kimi-k3/README.md`](../sources/kimi-k3/README.md)。
